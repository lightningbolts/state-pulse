...
import {AlertCircle, Database, ExternalLink, Mail, MapPin, Phone} from "lucide-react";
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm">
                                            {rep.addresses && rep.addresses.length > 0 && rep.addresses[0].phone && (
                                                <div className="flex items-center">
                                                    ...
                                                    <a href={`tel:${rep.addresses[0].phone}`}
                                        ...
                                        {rep.addresses && rep.addresses.length > 0 && (
                                            <div className="mt-4 pt-3 border-t border-border">
                                                <h6 className="text-sm font-medium text-muted-foreground mb-2">Office
                                                    Addresses</h6>
                                                        ...
                                                        <div key={idx} className="text-sm">
                                                            <div className="flex items-start gap-2">
                                                                ...
                                                                <div className="flex-1">
                                                                    <div
                                                                        className="font-medium text-muted-foreground text-xs uppercase tracking-wide mb-1">
                                                                        {office.type}
                                                                    </div>
                                                                    ...
                                                                    {(office.phone || office.fax) && (
                                                                        <div
                                                                            className="flex gap-4 mt-2 text-xs text-muted-foreground">
                                                                            {office.phone && (
                                                                                <div
                                                                            ...
                                                                            {office.fax && (
                                                                                <div
                                                                                    className="flex items-center gap-1">
                                                                                    <span
                                                                                        className="text-muted-foreground">Fax:</span>
                                                                                    {office.fax}
                                                                                </div>
                                                                            )}
                                                                        </div>
