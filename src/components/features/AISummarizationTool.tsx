    ...
    return (
        <Card className="shadow-lg">
            <CardHeader>
                ...
                <CardDescription>Get AI-powered summaries of legislative text in various styles. Paste the bill text
                    ...
                    <div className="mt-6 p-4 border rounded-md bg-muted/30">
                        ...
                        {summary && !isLoading && (
                            <p className="mt-2 text-xs text-muted-foreground">
                                Contextual footnotes (e.g., "this law is similar to Texas SB 8") would appear here if
                                available.
                            </p>
                        )}
                    </div>
