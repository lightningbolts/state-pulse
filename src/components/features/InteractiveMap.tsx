    ...
    <div className="space-y-6">
      <Card className="shadow-lg">
        ...
        <CardContent className="space-y-4 md:space-y-6">
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-center lg:text-left min-w-0 flex-1">
                      ...
                      {isDisabled && (
                        <div className="text-xs text-muted-foreground hidden lg:block mt-1">Coming Soon</div>
                      )}
                    </div>
                  </Button>
                );
                      ...
                      <div className="p-2 min-w-[180px] sm:min-w-[200px]">
                        ...
                        <div className="space-y-1 md:space-y-2 text-xs md:text-sm">
                          <div className="flex justify-between">
                            <span>Bills:</span>
                            <Badge variant="secondary" className="text-xs">{state.legislationCount}</Badge>
                          </div>
                          <div className="flex justify-between">
                            <span>Reps:</span>
                            <Badge variant="secondary" className="text-xs">{state.activeRepresentatives}</Badge>
                          </div>
                          <div className="flex justify-between">
                            <span>Recent:</span>
                            <Badge variant="secondary" className="text-xs">{state.recentActivity}</Badge>
                          </div>
          ...
          {/* Legend */}
          <div className="flex flex-col space-y-2 md:flex-row md:items-center md:justify-between md:space-y-0 text-xs text-muted-foreground">
