...
import { RefreshCw, Settings, AlertCircle, Target, Sparkles } from 'lucide-react';
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
export function VotingPredictionSection({ legislationId }: VotingPredictionSectionProps) {
  ...
  const {
    ...
    autoFetch: false // Changed to false for opt-in behavior
  });
        ...
        <Card className="border-dashed">
          <CardContent className="flex flex-col items-center justify-center py-8">
            ...
            <p className="text-muted-foreground text-center mb-4 max-w-md">
              Get an AI-powered voting outcome prediction for this legislation. Our system analyzes bill content, sponsor information, political context, and historical patterns.
            </p>
            <Button onClick={handleShowPrediction} disabled={isLoading} className="flex items-center gap-2">
